...
export default {
      ...
      this.http
        ...
        .then(res => {
          ...
          for (let i = 0; i < timesArray.length; i++) {
            _this.xdataArray.push(timesArray[i]);
            _this.ydataArray.push(valuesArray[i]);
            
          }
          console.log(_this.xdataArray)
  ...
  mounted() {
    ...
    this.getLineInfo('综合效率');
    this.getLineInfo('累计节约标煤');
    this.getLineInfo('余热功率');
    this.getLineInfo('燃气耗量');
  }
};
</script>
<style scoped>
